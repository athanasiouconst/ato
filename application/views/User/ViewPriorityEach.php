                        ...
                        <?php if (count($edit) > 0) : ?>
                            <?php foreach ($edit as $edit): ?>
                                ...
                                <tr class="insertform">
                                    <td>Α/Α</td>
                                    <td>
                                        <p><span title="αύξων αριθμός προτεραιότητας"><?= $edit['katigoria_proteraiotitas_id'] ?>
                                            </span>
                                    </td>
                                </tr>
                                <tr class="insertform">
                                    <td>Κωδικός</td>
                                    <td><span title="ο κωδικός της προτεραιότητας">
                                            <?= $edit['kp_code'] ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr class="insertform">
                                    <td>Περιγραφή</td>
                                    <td><span title="η περιγραφή της προτεραιότητας">
                                            <?= $edit['kp_perigrafi'] ?>
                                        </span>
                                    </td>
                                </tr>
