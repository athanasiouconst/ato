                        ...
                        <tr class="insertform">
                            <td>
                                ...
                                if ($status_id == 1 || $status_id == 2) {
                                    ...
                                    <tr class="insertform" >
                                        <td>
                                            <input type="hidden" name="peristatiko_key_notes" id="peristatiko_key_notes" placeholder="peristatiko_key_notes" value="<?php echo $gen->peristatiko_key_notes; ?>"  />
                                            <span title="Οι αλλαγές που πρέπει να γίνουν, σύμφωνα με το ΚΕΥ."><p style="font-size: 20px;color:black ;background-color: #ff4d4d"><?php echo $gen->peristatiko_key_notes; ?></p>
                                            </span></td>
                                    </tr>
                                <?php endif; ?>
                            <?php endif; ?>  
                            ...
                            <?php } else {
                                ?>
                            <tr class="insertform">
                                <td><span title="Η κατάσταση του Περιστατικού">
