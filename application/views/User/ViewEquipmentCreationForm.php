            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tr class="insertform">
                            <td>
                                <?php echo form_open('User/CreateEquipment') ?>    
                                <p><span title="Συμπληρώστε το είδος του εξοπλισμού">
                                        <input type="text" name="ex_eidos" id="ex_eidos" placeholder="Είδος" value="<?php echo set_value('ex_eidos'); ?>"  />
                                    </span>
                            </td>
                        </tr>
                        <tr class="insertform">
                            <td><span title="Συμπληρώστε τη περιγραφή του εξοπλισμού">   
                                    <textarea rows="6" name="ex_paratiriseis" class="input-block-level" placeholder="* Περιγραφή..." value="<?php echo set_value('ex_paratiriseis'); ?>" ></textarea>
