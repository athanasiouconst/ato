            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div style="float: right; padding-top: 40px;">
                        ...
                        echo anchor("User/TotalSearchStatistics/$date_before/$date_after", $vieweach, array('class' => 'btn btn-large btn-info', 'target' => '_blank', 'onClick' => "return confirm('Είστε σίγουρος για την επιλογή σας;;')"));
                        ?>
                        <br><br>
                    </div>
                    <?php
...
<!--                                <tr>
                                    <?php foreach ($fields as $field_name => $field_display): ?>
                                        <td <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order\"" ?>>
                                            <?php
                                            echo anchor("User/SearchStatistics/$field_name/" .
