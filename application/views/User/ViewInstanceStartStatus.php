                                ...
                                <tr>
                                    <?php foreach ($fields as $field_name => $field_display): ?>
                                        <td <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order\"" ?>>
                                            <?php
                                            echo anchor("User/ViewInstanceStartStatus/$field_name/" .
                                    ...
                                    <?php foreach ($fieldsStatus as $field_nameStatus => $field_display): ?>    
                                        <td <?php if ($sort_by == $field_nameStatus) echo "class=\"sort_$sort_order\"" ?>>
                                            <?php
                                            echo anchor("User/ViewInstanceStartStatus/$field_nameStatus/" .
                                                    ( ($sort_order == 'asc' && $sort_by == $field_nameStatus ) ? 'desc' : 'asc' ), $field_display);
                                            ?>
                                        </td>
                                    <?php endforeach; ?>

                                    <td colspan="0">Εκτυπωτικές Φόρμες</td>
                                    <td colspan="0">Επεξεργασία</td>
                                </tr>
                                        ...
                                        <?php foreach ($fields as $field_name => $field_display): ?>
                                            ...
                                            <?php } else if ($nameStatus == 1) {
                                                ...
                                                <td>
                                                    ...
                                                    $edit = '<span title="' . $peristatiko_id . '">Επεξεργασία</span>';
                                                    $editEquipment = '<span title="' . $peristatiko_id . '">Εξοπλισμός</span>';
                                                    $editExplosive = '<span title="' . $peristatiko_id . '">Εκρηκτικά</span>';
                                                    $delete = '<span title="' . $peristatiko_id . '">Διαγραφή</span>';
                                                    $vieweach = '<span title="' . $peristatiko_id . '">Προβολή</span>';
                                                    ?>
                                                    <?php
                                                    ...
                                                    echo anchor("User/ViewInstanceEdit/$peristatiko_id", $edit, array('onClick' => "return confirm('Είστε σίγουρος για τις αλλαγές;;')"));
                                                    echo "<br>";
                                                    echo anchor("User/ViewInstanceOneEquipment/$peristatiko_id", $editEquipment, array('onClick' => "return confirm('Είστε σίγουρος για τις αλλαγές;;')"));
                                                    echo "<br>";
                                                    echo anchor("User/ViewInstanceOneExplosive/$peristatiko_id", $editExplosive, array('onClick' => "return confirm('Είστε σίγουρος για τις αλλαγές;;')"));
                                                    echo "<br>";
