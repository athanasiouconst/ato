                        ...
                        <?php if (count($edit) > 0) : ?>
                            <?php foreach ($edit as $edit): ?>
                                ...
                                <tr class="insertform">
                                    <td>Α/Α</td>
                                    <td>
                                        <p><span title="αύξων αριθμός αρμοδιότητας"><?= $edit['katanomi_armodiotiton_id'] ?>
                                            </span>
                                    </td>
                                </tr>
                                <tr class="insertform">
                                    <td>Αρμοδιότητες</td>
                                    <td><span title="η ονομασία αρμοδιότητας">
                                            <?= $edit['ka_armodiotites'] ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr class="insertform">
                                    <td>Περιγραφή</td>
                                    <td><span title="η περιγραφή της αρμοδιότητας">
                                            <?= $edit['ka_perigrafi_armodiotiton'] ?>
                                        </span>
                                    </td>
                                </tr>
