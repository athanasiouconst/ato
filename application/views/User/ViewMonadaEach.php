                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <?php if (count($edit) > 0) : ?>
                            <?php foreach ($edit as $edit): ?>
                                ...
                                <tr class="insertform">
                                    <td>Ονομασία Σχηματισμού/Μονάδος</td>
                                    <td><span title="Ονομασία Σχηματισμού/Μονάδος">
                                            <?= $edit['monada_name'] ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr class="insertform">
                                    <td>Περιοχή Σχηματισμού/Μονάδος</td>
                                    <td><span title="Περιοχή Σχηματισμού/Μονάδος">
                                            <?= $edit['monada_area'] ?>
                                        </span>
                                    </td>
                                </tr>
