            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tr class="insertform">
                            <td>
                                <?php echo form_open('User/CreateMonada') ?>    
                                <p><span title="Συμπληρώστε την ονομασία του/της Σχηματισμού/Μονάδος">
                                        <input type="text" name="monada_name" id="monada_name" placeholder="Ονομασία" value="<?php echo set_value('monada_name'); ?>"  />
                                    </span>
                            </td>
                        </tr>
                        <tr class="insertform">
                            <td><span title="Συμπληρώστε τη περιοχή του/της Σχηματισμού/Μονάδος">   
                                    <input type="text" name="monada_area" id="monada_area" placeholder="Περιοχή" value="<?php echo set_value('monada_area'); ?>"  />
