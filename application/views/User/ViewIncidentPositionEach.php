                        ...
                        <?php if (count($edit) > 0) : ?>
                            <?php foreach ($edit as $edit): ?>
                                ...
                                <tr class="insertform">
                                    <td>Α/Α</td>
                                    <td>
                                        <p><span title="αύξων αριθμός της θέσης συμβάντος"><?= $edit['thesi_simvantos_id'] ?>
                                            </span></td>
                                </tr>
                                <tr class="insertform">
                                    <td>Περιγραφή</td>
                                    <td><span title="η θέση συμβάντος">
                                            <?= $edit['ts_thesi'] ?>
                                        </span></td>
                                </tr>
                                <tr class="insertform">
                                    <td>Κωδικός</td>
                                    <td><span title="ο κωδικός της θέσης συμβάντος">
                                            <?= $edit['ts_value'] ?>
                                        </span></td>
                                </tr>
                                <tr class="insertform">
                                    <td>Περιγραφή</td>
                                    <td><span title="η περιγραφή της θέσης συμβάντος">
                                            <?= $edit['ts_perigrafi'] ?>
                                        </span></td>
                                </tr>
