        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <table class="table table-hover table-striped">
                        <?php if (count($editExplosive) > 0) : ?>
                            <?php foreach ($editExplosive as $editExplosive): ?>
                                <tr class="insertform">
                                    <td>        
                                        <span title="Είδος του εκρηκτικού">
                                            <?= $editExplosive['ek_eidos'] ?>
                                        </span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        ...
                        <?php if (count($edit) > 0) : ?>
                            <?php foreach ($edit as $edit): ?>
                                ...
                                <?php echo form_open('User/ViewExplosiveLotEditForm') ?>
                                <p><input type="hidden" size="80" id="ekriktika_lot_id" name="ekriktika_lot_id" value="<?= $edit['ekriktika_lot_id'] ?>"/>    

                                <tr class="insertform">
                                    <td>     
                                        <p> <span title="Συμπληρώστε τη μερίδα του εκρηκτικού">                               
                                                <input type="text" name="lot" id="lot" placeholder="Μερίδα Εκρηκτικού" value="<?= $edit['lot'] ?>"  />
