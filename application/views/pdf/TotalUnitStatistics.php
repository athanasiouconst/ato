...
$queryPD1 = "SELECT * FROM peristatiko "
        ...
        . " where monada.monada_id= '" . $monada_id . "' "
...
for ($i = 0; $i < $num_PD1; $i++) {
    ...
    $html = '<table style="font-size:16px; text-align:center;"><tr><td>ΒΡΕΘΗΚΑΝ ΣΥΝΟΛΙΚΑ <b><i>' . $num_PD2 . '</i></b> ΠΕΡΙΣΤΑΤΙΚΑ ΤΟΥ/ΤΗΣ ΣΧΗΜΑΤΙΣΜΟΥ/ΜΟΝΑΔΟΣ :  <b><i> ' . $monada_name . ' </i></b></td></tr>'
