...
for ($i = 0; $i < $num_PD1; $i++) {
    ...
    $sximatismos_name = mysql_result($PD1, $i, 'sximatismos_name');
    ...
    $html = '<table style="font-size:16px; text-align:center;"><tr><td>ΒΡΕΘΗΚΑΝ ΣΥΝΟΛΙΚΑ <b><i>' . $num_PD2 .  '</i></b> ΠΕΡΙΣΤΑΤΙΚΑ ΤΟΥ ΣΧΗΜΑΤΙΣΜΟΥ :  <b><i> ' . $sximatismos_name . ' </i></b></td></tr>'
...
$htm2 = '<table style="width:100%;height:100%;font-size:11px; text-align:center;padding:4px;">'
        ...
        . '<td style="background-color: grey;border:1px solid black;width:12%">ΜΟΝΑΔΑ</td>'
...
for ($i = 0; $i < $num_PD2; $i++) {
    ...
    $htm3 = '<table style="width:100%;height:100%;font-size:11px; text-align:center;padding:4px;">'
            ...
            . '<td style="background-color: white;border:1px solid black;width:12%">' . $monada_name . '</td>'
